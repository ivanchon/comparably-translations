module.exports = {
    ...
    summary_byMetro_noData_noCompany: "Empresas cercanas: calificaciones insuficientes",

    label_competitor: "competidor",
    label_competitors: "competidores",

    summary_competitor: "[local:companyName] actualmente ocupa el [local:rank] lugar frente a <a href=\"[local:competitorsURL]\">[local:competitorsCount] [local:competitorsLabel]</a>",
    summary_competitor_noLink: "[local:companyName] actualmente ocupa el [local:rank] lugar frente a <b>[local:competitorsCount] [local:competitorsLabel]</b>",
    summary_competitor_noCompany: "[local:rank] lugar frente a <a href=\"[local:competitorsURL]\">[local:competitorsCount] [local:competitorsLabel]</a>",
    summary_competitor_noCompany_noLink: "[local:rank] lugar frente a <b>[local:competitorsCount] [local:competitorsLabel]</b>",
    summary_competitor_noData: "[local:companyName] no tiene suficientes clasificaciones para clasificar contra competidores",
    summary_compettior_noData_noCompany: "Competidores: calificaciones insuficientes",
};